 ...
 */
  ...
  /* Ejercicio  5) Programa una función que invierta las palabras de una cadena de texto, pe. miFuncion("Hola Mundo") devolverá "odnuM aloH".*/
    ...
    let lorem = "lorem ipsum , dolor , lorem ipsum que iquno lorem loras"

    const contarVeces = (texto = "", palabra = undefined) =>
        (!texto)
            ?console.log("no ingresaste el texto")
            :(!palabra)
                ?console.log("no ingresaste el texto")
                :console.log("ingresaste ambas")

    contarVeces("", "lore")
    contarVeces(lorem)
    contarVeces(lorem, 'lore');